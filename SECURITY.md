...
Security updates will always only be applied to the latest version of Lighthouse.
...
Please report critical vulnerabilities that might open up for external attacks privately
via GitHub Security Advisories on this repository:
https://github.com/grioghar/lighthouse/security/advisories/new
